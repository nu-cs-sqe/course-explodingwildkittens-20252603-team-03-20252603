...
| attack_TwoStackedAttacks_FirstTurn_NotNoped_NextPlayerAttacked  | two stacked attacks, attacks on first turn, not noped | next player attacked (6) | :x:                |
| attack_TwoStackedAttacks_FirstTurn_Noped_NextPlayerNotAttacked  | two stacked attacks, attacks on first turn, noped     | next player not attacked | :x:                |
